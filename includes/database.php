...
// SQL command to create the database 'kidsGames'
...
if ($mysqli->query($sql) === TRUE) {
    ...
    echo "Something went wrong with the DB creation: " . $mysqli->error;
}
 
$mysqli->close();

$mysqli = new mysqli($host, $username, $password, 'kidsGames');

if ($mysqli->connect_error) {
    die("Connection failed: " . $mysqli->connect_error);
}
 
// SQL script to create tables and view
$sqlScript = "
